...
(function() {
  ...
  Object.defineProperties(TextManager, {
    ...
    'カ': {value: 'B'}, 'キ': {value: 'P'}, 'ク': {value: 'M'}, 'ケ': {value: 'F'}, 'コ': {value: 'D'},
    'サ': {value: 'T'}, 'ス': {value: 'L'}, 'セ': {value: 'G'}, 'ソ': {value: 'K'},
    'タ': {value: 'H'}, 'テ': {value: 'X'}, 'ト': {value: 'Z'},
    'ナ': {value: 'C'}, 'ニ': {value: 'S'}, 'ヌ': {value: 'R'}, 'ネ': {value: 'Y'}, 'ノ': {value: 'W'},
    'ハ': {value: 'Q'}, 'ヒ': {value: 'HI'}, 'ヘ': {value: 'HE'}, 'ホ': {value: 'HO'},
    'マ': {value: 'J'}, 'ミ': {value: 'MI'}, 'ム': {value: 'MU'}, 'メ': {value: 'ME'}, 'モ': {value: 'MO'},
    'ヤ': {value: 'N'}, 'ユ': {value: 'YU'}, 'イェ': {value: 'YE'}, 'ヨ': {value: 'YO'},
